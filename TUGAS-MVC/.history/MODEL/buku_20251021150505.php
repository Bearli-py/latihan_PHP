...
class Buku {
    ...
    public static function semuaBuku() {
        ...
        $buku1 = new Buku("Jaringan Komputer", "Rizky Ananda", 2023);
        $buku2 = new Buku("Desain UI/UX", "Nabila Putri", 2022);
        $buku3 = new Buku("Manajemen Operasi", "Andhika Pratama", 2021);
        $buku4 = new Buku("Interpersonal Skill", "Bagas Wicaksono", 2020);
        $buku5 = new Buku("Workshop Sistem Terintegrasi", "Siti Rahma", 2024);
        $buku6 = new Buku("Sistem Cerdas", "Fadli Ramadhan", 2019);
